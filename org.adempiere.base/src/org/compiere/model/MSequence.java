...
public class MSequence extends X_AD_Sequence
{
	...
	public static int getNextID (int AD_Client_ID, String TableName, String trxName)
	{
		...
		ResultSet rs = null;
		//Added By Argenis Rodríguez 2020-11-27 19:40
		int queryTimeOut = MSysConfig.getIntValue("AD_SEQUENCE_QUERY_TIMEOUT", 0);
		...
		for (int i = 0; i < 3; i++)
		{
			try
			{
				...
				//
				if (DB.getDatabase().isQueryTimeoutSupported() && queryTimeOut > 0)
				{
