...
as SELECT h.ad_client_id,
   ...
   FROM m_inout h
     ...
     LEFT JOIN c_bpartner_location cbl ON cb.c_bpartner_id = cbl.c_bpartner_id AND co.c_bpartner_location_id = cbl.c_bpartner_location_id
  ...
  WHERE ol.qtydelivered > ol.qtyinvoiced AND co.issotrx = 'Y'::bpchar;
